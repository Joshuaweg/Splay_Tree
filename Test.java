...
public class Test {
	...
	public static void main(String[] args) {
		SplayBSTXtra0 t = new SplayBSTXtra0();
		...
		t.insert("miki"); t.insert("john"); System.out.println("b4 kel " + t); t.insert("kelly"); System.out.println(t);t.insert("nichole");
		System.out.println(t);
		System.out.println();
		System.out.println();
...
class SplayBSTXtra0 extends SplayBST {
